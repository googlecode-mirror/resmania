...
Ext.ux.Printer.BaseRenderer = Ext.extend(Object, {
  ...
  print: function(component) {
    ...
    var newwindowleft = screen.width;
    var newwindowtop = screen.height+400;
    var win = window.open('', name ,'height=10,width=10,left='+newwindowleft+',top='+newwindowtop+',screenX='+newwindowleft+',screenY='+newwindowtop);
