...
Ext.DataView.DragZone = function(view, config){
    this.view = view;
    ...
    Ext.DataView.DragZone.superclass.constructor.call(this, this.view.getEl(), { containerScroll: true, ddGroup: dd });
    this.setDraggable(ddGroup);
};

Ext.extend(Ext.DataView.DragZone, Ext.dd.DragZone, {
