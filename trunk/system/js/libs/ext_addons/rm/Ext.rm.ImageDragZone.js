 ...
 */
Ext.rm.ImageDragZone = function(view, config){
    this.view = view;
    Ext.rm.ImageDragZone.superclass.constructor.call(this, view.getEl(), config);
};
Ext.extend(Ext.rm.ImageDragZone, Ext.dd.DragZone, {
    ...
    getTreeNode : function(){
        ...
        //TODO: this is not works, 'cause new node is not in the tree right now, we need other way to fix this.
        this.onNodeDropEvent();
        return treeNodes;
    },
